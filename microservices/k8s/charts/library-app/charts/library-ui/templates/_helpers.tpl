...
app.kubernetes.io/name: {{ include "library-ui.name" . }}
...
*/}}
{{- define "library-ui.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "library-ui.fullname" .) .Values.serviceAccount.name }}
{{- else }}
